    ...
    <div className="bg-gradient-to-b from-gray-50 to-white py-12 md:py-20">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-8 xl:gap-12">
          {/* Navigation */}
          <div className="lg:w-1/4 xl:w-1/5 flex flex-col items-end">
            <div className="mb-8 lg:mb-12 w-48">
              <img
                src={logo}
                loading="lazy"
            ...
            <div className="w-full max-w-xs lg:w-auto">
              <div 
                ...
                className="flex lg:flex-col gap-1 border-b lg:border-b-0 lg:border-r border-gray-200"
              >
                <button
                  role="tab"
