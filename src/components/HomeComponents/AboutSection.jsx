...
const AboutSection = () => {
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: true,
      disable: true, // ✅ Enable animations on mobile
    });
          ...
          <div className="lg:w-2/5" data-aos="fade-right">
            <div className="relative">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight mb-6">
                ...
                <span className="text-[var(--color-secondary)]">Knowledge</span>{' '}
                Engineering
              </h2>
          ...
          <div className="lg:w-3/5" data-aos="fade-left">
            <div className="relative">
              <p className="text-gray-700 leading-relaxed text-lg md:text-xl">
                Our focus is on partnering with you to deliver exceptional yet
                cost-effective solutions to showcase your talents to the world
                and establish you as an achiever to have a lasting impact on
                your surroundings.
              </p>
